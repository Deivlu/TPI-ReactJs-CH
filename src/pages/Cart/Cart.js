    ...
    <div className="cart__container">
      ...
      {exito && (
        <div style={{ color: "white" }}>
          ...
          <br />
          <h4>
            La misma se ha registrado con el identificador n° <i>{exito}</i>.
          </h4>
          <br />
          <br />
          <br />
      ...
      {cart.length > 0 ? (
        cart.map((item) => (
          <div key={item.id} className="cart__card">
            <img className="cart__card--img" src={item.imgurl}></img>
            ...
            <div className="cart__card--eliminar">
              <button
                ...
                className="cart__card--finalizar--boton"
              >
        ...
        <Link to="/" className="cart__card--finalizar--boton">
          Continuar comprando
        </Link>
      ) : (
        <>
      ...
      {cart.length > 0 && (
        <div className="cart__card--finalizar">
          ...
          <button onClick={clear} className="cart__card--finalizar--boton">
            Vaciar carrito
          </button>
          <br />
          <br />
          ...
          <div className="cart__card--send">
            <p>
              Nombre:{" "}
              <input type="text" id="name" onChange={changeFields}></input>
            </p>
            <p>
              Teléfono:{" "}
              <input type="tel" id="phone" onChange={changeFields}></input>
            </p>
            <p>
              E-mail:{" "}
              <input type="email" id="email" onChange={changeFields}></input>
            </p>
            <p>
              Confirma E-mail:{" "}
              <input type="email" id="email2" onChange={changeFields}></input>
            </p>
            <br></br>
            <button
              className="cart__card--finalizar--boton"
